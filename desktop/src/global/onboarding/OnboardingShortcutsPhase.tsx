...
const TRIGGER_KEYS_BY_PLATFORM: Record<
  string,
...
function TriggerHint({ platform }: { platform?: string }) {
  const key =
    TRIGGER_KEYS_BY_PLATFORM[platform ?? ""] ?? TRIGGER_KEYS_BY_PLATFORM.darwin;
  return (
...
const GLOBAL_ACTIONS: {
...
}[] = [
  {
    ...
    resultBody:
      "A lightweight chat with me opens over what you were already doing.",
  ...
  },
  {
    ...
    resultBody:
      "I grab the area you marked and open it as context for the next question.",
  ...
  },
  {
    ...
    resultBody:
      "I quietly stage the active window or selection so the next question already knows about it.",
  ...
  },
  {
    ...
    resultBody:
      "Talk naturally and I'll keep the current context while transcribing.",
...
const MENU_HEIGHT =
  GLOBAL_ACTIONS.length * MENU_ITEM_HEIGHT + MENU_PADDING_Y * 2;
...
export function OnboardingShortcutsPhase({
  ...
  const handleSurfaceContextMenu = useCallback(
    (event: ReactMouseEvent<HTMLDivElement>) => {
      ...
      const x = clamp(
        ...
        8,
        rect.width - MENU_WIDTH - 8,
      );
      const y = clamp(
        event.clientY - rect.top,
        8,
        rect.height - MENU_HEIGHT - 8,
      );
      setMenuAnchor({ x, y });
      setMenuOpen(true);
    },
  ...
  const finishVisible =
    mode === "global" ? menuResult !== null : localResult !== null;
          ...
          <section className="onboarding-shortcut-demo">
            <div className="onboarding-shortcut-demo__copy">
              <span className="onboarding-step-label">
                How to use Stella on your computer
              </span>
            </div>
            ...
            >
              {!menuOpen && !menuResult && (
                <div className="onboarding-shortcut-surface__instruction">
                  <h3 className="onboarding-shortcut-demo__title">
                    <TriggerHint platform={platform} /> anywhere to open the
                    menu.
                  </h3>
                </div>
              )}
              <div className="onboarding-shortcut-scene onboarding-shortcut-scene--article">
                <div className="onboarding-shortcut-window onboarding-shortcut-window--bg">
                  ...
                  <div className="onboarding-shortcut-window__body onboarding-shortcut-window__body--bg">
                    <div className="mock-notes">
                      <div className="mock-notes__title" />
                      <div className="mock-notes__line" />
                      <div className="mock-notes__line mock-notes__line--med" />
                      <div className="mock-notes__line mock-notes__line--short" />
                      <div className="mock-notes__line" />
                    </div>
                  </div>
                </div>
                ...
                <div className="onboarding-shortcut-taskbar">
                  <span aria-label="Finder" />
                  <span aria-label="Browser" />
                  <span aria-label="Notes" />
                ...
                <div className="onboarding-shortcut-window onboarding-shortcut-window--main">
                  ...
                  <div className="onboarding-shortcut-window__body">
                    <div className="mock-report">
                      <span className="mock-report__eyebrow">
                        Q2 2026 Analysis
                      </span>
                      <h4 className="mock-report__title">
                        Market Performance Overview
                      </h4>
                      <p className="mock-report__text">
                        Revenue increased 23% year-over-year, driven by strong
                        enterprise adoption across three core verticals. The
                        mid-market segment showed early traction with 14%
                        quarterly growth.
                      </p>
                      <div className="mock-report__cards">
                        <div className="mock-report__card">
                          <span className="mock-report__card-label">
                            Revenue by quarter
                          </span>
                          <svg
                            className="mock-report__chart"
                            viewBox="0 0 160 60"
                            fill="none"
                          >
                            <rect
                      ...
                      <h5 className="mock-report__subtitle">
                        Pipeline &amp; Outlook
                      </h5>
                      <p className="mock-report__text">
                        Enterprise pipeline expanded to 340 qualified
                        opportunities, up from 218 in the prior quarter. Win
                        rates held steady at 32%, with average deal size
                        increasing 11% to $48K.
                      </p>
                      <p className="mock-report__text mock-report__text--sm">
                        Regional breakdown shows EMEA leading at 41% of new
                        bookings, followed by NA at 38% and APAC at 21%. The
                        APAC segment represents the fastest-growing region
              ...
              <div
                ...
                aria-hidden="true"
                data-capture-phase={
                  capturePhase !== "idle" ? capturePhase : undefined
                }
              ...
              >
                      ...
                      <div className="scene-effect__mini-shell">
                        ...
                        <div className="scene-effect__mini-shell-messages">
                          ...
                          <div className="scene-effect__mini-shell-msg scene-effect__mini-shell-msg--assistant">
                            I can see the chart from your report. What would you
                            like to know about the revenue trends?
                          </div>
                        </div>
                ...
                <div className="scene-effect scene-effect--chat">
                  <div className="scene-effect__mini-shell">
                    ...
                    <div className="scene-effect__mini-shell-messages">
                      <div className="scene-effect__mini-shell-msg scene-effect__mini-shell-msg--assistant">
                        I can see your research report. What would you like to
                        know?
                      </div>
                      ...
                      <div className="scene-effect__mini-shell-msg scene-effect__mini-shell-msg--assistant">
                        The report highlights three main findings: revenue grew
                        23% YoY, enterprise is the leading segment, and the Q3
                        pipeline needs expansion.
                      </div>
                    </div>
                    <div className="scene-effect__mini-shell-composer">
                ...
                <div className="scene-effect scene-effect--voice">
                  ...
                  <span className="scene-effect__voice-label">
                    Listening...
                  </span>
                </div>
              </div>

              <div className="onboarding-shortcut-hint">Try it here</div>
