...
/** Ceiling on honoring a provider-supplied Retry-After between resumes. */
...
type ExecutionResult = {
  finalText: string;
  errorMessage?: string;
  /** Provider-supplied Retry-After parked on the failed assistant tail. */
  retryAfterMs?: number;
};
