...
export function UserMessageBody({ text }) {
    ...
    return (<div className="event-user-body" data-expanded={expanded}>
      <div ref={bodyRef} className="event-body">
        <ModelMentionText text={text}/>
      </div>
      {showToggle && (<button type="button" className="event-user-toggle" onClick={toggle} aria-expanded={expanded}>
