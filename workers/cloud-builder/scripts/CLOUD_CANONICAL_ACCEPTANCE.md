...
memory/skills, a signed-in mobile authority/outbox/clean-hydration path,
...
| `apps_host_workerd_runtime`         | exact Apps Host worker/deployment/Wrangler identities; non-empty production bundle digest/bytes; hashed KV/R2 route and object receipts; Workerd health and GET/HEAD app asset responses; strict CSP assertions; unauthenticated proxy requests rejected before fetch; invalid authority binding returns 503; runtime disposed and isolated persistence removed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
