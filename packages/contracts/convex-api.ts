...
export type PublicApiType = {
  ...
  "execution_placement": {
    "submitMyBrowserExecution": FunctionReference<'mutation', 'public', { threadId?: string | undefined; parentTurnId?: string | undefined; conversationId: string; kind: 'agent' | 'chat'; idempotencyKey: string; payloadJson: string; subject: 'computer' | 'cloud' | 'portable'; payloadHash: string; requiredCapabilities: ('agent' | 'chat' | 'computer-use' | 'local-files' | 'local-apps')[]; expectedOwnerGeneration: string; }, any, string | undefined>;
