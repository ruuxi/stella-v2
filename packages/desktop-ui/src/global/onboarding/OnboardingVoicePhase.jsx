...
const DICTATED_SENTENCE = "Hey Alex, pushing the launch to next Tuesday so we have time to polish the deck.";
...
export function OnboardingVoicePhase({ splitTransitionActive, onContinue, }) {
    ...
    return (<div className="onboarding-step-content ovoice-step">
        ...
        <section className="ovoice-card">
          ...
          <div className="ovoice-card__surface" aria-hidden="true">
            <div className="ovoice-talk">
              <div className="ovoice-talk__quote" data-visible={(talk("hey") && !talk("bye")) || undefined}>
                "Hey Stella"
              </div>
              ...
              <div className="ovoice-talk__exchange">
                <span className="ovoice-talk__reply" data-visible={(talk("reply") && !talk("bye")) || undefined}>
                  Hi. What should we get done?
                </span>
                <span className="ovoice-talk__quote ovoice-talk__quote--bye" data-visible={talk("bye") || undefined}>
                  "Bye"
                </span>
              </div>
            </div>
        ...
        <section className="ovoice-card">
          ...
          <div className="ovoice-card__surface" aria-hidden="true">
            <div className="ovoice-dictate">
              <div className="ovoice-dictate__chord" data-held={keyHeld || undefined}>
                <Keychord aria={dictateKey.aria} glyphs={dictateKey.glyphs} size="compact" highlight={keyHeld}/>
...
function FakeWaveform({ active }) {
    return (<div className="ovoice-waveform" data-active={active || undefined}>
      {WAVEFORM_BARS.map((bar) => (<span key={bar.key} className="ovoice-waveform__bar" style={bar.style}/>))}
    </div>);
}
