...
describe("general agent turn request parsing", () => {
  ...
  test("rejects each missing or malformed field by name", () => {
    const cases: Array<[Record<string, unknown>, string]> = [
      ...
      [{ audience: "enterprise" }, "audience"],
      [{ audience: undefined }, "audience"],
      [{ budgetMicroCents: "unlimited" }, "budgetMicroCents"],
      [{ budgetMicroCents: Number.POSITIVE_INFINITY }, "budgetMicroCents"],
      [{ budgetMicroCents: undefined }, "budgetMicroCents"],
