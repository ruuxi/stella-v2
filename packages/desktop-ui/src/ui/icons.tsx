...
function createIcon(name: string, children: ReactNode) {
    const Icon = forwardRef<SVGSVGElement, IconProps>(function StellaIcon({ size = 24, strokeWidth = 2, className, ...rest }, ref) {
...
export const LogIn = createIcon("log-in", <path d="M13.5 4.25h3.25a3 3 0 0 1 3 3v9.5a3 3 0 0 1-3 3H13.5M4 12h9.25M9.75 8.5 13.25 12l-3.5 3.5"/>);
export const LogOut = createIcon("log-out", <path d="M10.5 4.25H7.25a3 3 0 0 0-3 3v9.5a3 3 0 0 0 3 3h3.25M9.5 12H20M16.5 8.5 20 12l-3.5 3.5"/>);
...
export const Phone = createIcon("phone", <path d="M7.6 4.1c.62-.62 1.64-.56 2.2.12l1.55 1.93c.46.57.46 1.39 0 1.96l-1 1.27a.94.94 0 0 0-.07 1.1 13.1 13.1 0 0 0 3.64 3.64c.34.23.8.2 1.1-.07l1.27-1a1.56 1.56 0 0 1 1.96 0l1.93 1.55c.68.56.74 1.58.12 2.2l-1.05 1.05c-.9.9-2.24 1.23-3.44.77-2.52-.97-4.9-2.5-6.9-4.5s-3.53-4.38-4.5-6.9c-.46-1.2-.13-2.54.77-3.44Z"/>);
...
export const AudioLines = createIcon("audio-lines", <path d="M4.5 10.5v3M8.25 7.5v9M12 4.5v15M15.75 8.5v7M19.5 10.5v3"/>);
...
export const Scan = createIcon("scan", <path d="M8.5 4.25H7A2.75 2.75 0 0 0 4.25 7v1.5M15.5 4.25H17A2.75 2.75 0 0 1 19.75 7v1.5M8.5 19.75H7A2.75 2.75 0 0 1 4.25 17v-1.5M15.5 19.75H17A2.75 2.75 0 0 0 19.75 17v-1.5"/>);
/* -------------------------------- documents ------------------------------ */
const filePaths = (<>
...
export const Folder = createIcon("folder", <path d="M3.75 7A2.75 2.75 0 0 1 6.5 4.25h2.9c.73 0 1.42.32 1.9.88l.9 1.06c.28.34.7.53 1.14.53h4.16a2.75 2.75 0 0 1 2.75 2.78v8A2.75 2.75 0 0 1 17.5 20.25h-11A2.75 2.75 0 0 1 3.75 17.5Z"/>);
...
export const ClipboardPaste = createIcon("clipboard-paste", <>
    <path d="M8.5 4.5H8a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-10a3 3 0 0 0-3-3h-.5"/>
    <rect x="9" y="2.75" width="6" height="3.5" rx="1.75"/>
    <path d="M12 9.75v6.5M9.5 13.75 12 16.25l2.5-2.5"/>
  </>);
export const TextQuote = createIcon("text-quote", <>
...
export const SquarePen = createIcon("square-pen", <>
...
export const Paperclip = createIcon("paperclip", <path d="m20.2 11.1-7.48 7.48a4.55 4.55 0 0 1-6.43-6.43l7.48-7.48a3.03 3.03 0 0 1 4.29 4.29l-7.13 7.13a1.52 1.52 0 0 1-2.14-2.14l6.77-6.78"/>);
...
export const Wand2 = createIcon("wand-2", <>
...
export const AppWindowMac = createIcon("app-window", <>
    <rect x="3.25" y="4.75" width="17.5" height="14.5" rx="3"/>
    <path d="M6.75 8.25h.01M9.75 8.25h.01M12.75 8.25h.01"/>
  </>);
export const LayoutList = createIcon("layout-list", <>
