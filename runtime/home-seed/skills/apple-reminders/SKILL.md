...
description: "Manage Apple Reminders from the terminal via the remindctl CLI — add, list, complete, and set due dates/alarms that sync to the user's iPhone and iPad over iCloud. macOS only. Use when the user mentions Reminders or wants a to-do on their Apple devices."
---
...
- Scheduling Stella alerts/notifications → use Stella's `Schedule` instead
- Calendar events → use Apple Calendar or Google Calendar
- Project task management → use GitHub Issues, Notion, etc.
- If user says "remind me" but means a Stella alert → clarify first
...
1. When user says "remind me", clarify: Apple Reminders (syncs to phone) vs a Stella scheduled alert
