...
// the character mark, LegalDialog) into the main bundle. Always import the
...
/** The mark fills the slot its container sizes, rather than a fixed px edge. */
...
export function OnboardingView({
  ...
  // The creature is the hero visual of onboarding, so it runs freely while it
  // is the whole screen. Once the split pushes it aside it is decoration, and
  // on a low-power tier decoration isn't worth an animation frame.
