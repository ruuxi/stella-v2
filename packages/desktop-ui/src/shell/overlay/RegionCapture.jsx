...
export function RegionCapture() {
    ...
    const [vacuum, setVacuum] = useState(null);
    ...
    const lastProbedPointRef = useRef(null);
    ...
    const previewWindowAtPoint = useCallback((point) => {
    ...
    const handleMouseUp = async (event) => {
        ...
        if (resolvedSelection.width < MIN_SELECTION_SIZE ||
    ...
    return (<div className="region-capture-root" onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onContextMenu={handleContextMenu}>
      {!selection &&
            !vacuum &&
            !isPreparingCapture &&
            !dimSuppressedAfterVacuum && <div className="region-capture-dim"/>}
      {selection && (<div className="region-capture-selection" style={{
                left: selection.x,
                top: selection.y,
                width: selection.width,
                height: selection.height,
            }}/>)}
      {vacuum && (<canvas ref={canvasRef} className="region-capture-vacuum" style={{
