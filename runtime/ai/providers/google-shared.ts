...
// Used for unsigned function call parts replayed from providers without signatures.
		...
		if (msg.role === "user") {
			...
			for (const block of msg.content) {
				if (block.type === "text") {
					...
					// Use the official sentinel for replayed unsigned tool calls so structured
					// tool-call context is preserved across turns.
