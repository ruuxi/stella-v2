...
export const MOBILE_BRIDGE_CAPABILITIES = [
  ...
  event("theme.onChange", IPC_THEME_CHANGE),
  ...
  invoke("agent.getLastSelfModFeature", IPC_SELFMOD_LAST_FEATURE),
  invoke("agent.listSelfModFeatures", IPC_SELFMOD_RECENT_FEATURES),
