 ...
 * resolution and seeding, bundled skills/extensions reconciliation, and
 * device identity. Effect-native runtime code consumes this service; the legacy
 ...
 * holds no OS resources of its own.
 */
