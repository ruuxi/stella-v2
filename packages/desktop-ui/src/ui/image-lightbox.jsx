 ...
 */
export function ImageLightbox({ open, onOpenChange, src, alt, className, }) {
    return (<DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay data-component="image-lightbox-overlay"/>
        <div data-component="image-lightbox">
          <DialogPrimitive.Content data-slot="image-lightbox-content" className={cn(className)} aria-describedby={undefined}>
            <VisuallyHidden asChild>
              <DialogPrimitive.Title>
                {alt || "Image preview"}
              </DialogPrimitive.Title>
            </VisuallyHidden>
            <img data-slot="image-lightbox-image" src={src} alt={alt ?? ""}/>
            <DialogPrimitive.Close data-slot="image-lightbox-close" aria-label="Close preview">
              <X size={18}/>
