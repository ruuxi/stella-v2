...
export const MOBILE_BRIDGE_CAPABILITIES = [
    ...
    invoke("system.sendMagicLink", IPC_AUTH_MAGIC_LINK_SEND),
    invoke("system.getMagicLinkStatus", IPC_AUTH_MAGIC_LINK_STATUS),
