...
export function AccountTab({ onSignOut, onOpenLegal }) {
    const t = useT();
    const { hasConnectedAccount } = useAuthSessionState();
    const resetUserData = useAction(api.reset.resetAllUserData);
    const [pendingDeleteAction, setPendingDeleteAction] = useState(null);
    const [isDeleting, setIsDeleting] = useState(false);
    const closeDeleteDialog = useCallback((open) => {
        if (!open && !isDeleting) {
    ...
    const handleConfirmDelete = useCallback(async () => {
        ...
        try {
            ...
            console.error(error);
            showToast(getSettingsErrorMessage(error, action === "data"
    ...
    return (<div className="settings-tab-content">
      <div className="settings-card">
        ...
        <div className="settings-row">
          ...
          <div className="settings-row-control">
            <Button type="button" variant="ghost" className="pill-btn" onClick={onSignOut}>
        ...
        <div className="settings-row">
          ...
          <div className="settings-row-control">
            <Button type="button" variant="ghost" className="pill-btn pill-btn--danger" onClick={() => setPendingDeleteAction("data")} disabled={isDeleting}>
        ...
        <div className="settings-row">
          ...
          <div className="settings-row-control">
            <Button type="button" variant="ghost" className="pill-btn pill-btn--danger" onClick={() => setPendingDeleteAction("account")} disabled={isDeleting || !hasConnectedAccount}>
      ...
      <div className="settings-card">
        ...
        <div className="settings-row">
          ...
          <div className="settings-row-control">
            <Button type="button" variant="ghost" className="pill-btn" onClick={() => onOpenLegal?.("terms")}>
        ...
        <div className="settings-row">
          ...
          <div className="settings-row-control">
            <Button type="button" variant="ghost" className="pill-btn" onClick={() => onOpenLegal?.("privacy")}>
              {t("settings.account.legal.view")}
            </Button>
          </div>
        </div>
      </div>
      <Dialog open={pendingDeleteAction !== null} onOpenChange={closeDeleteDialog}>
        <DialogContent fit className="settings-confirm-dialog" aria-describedby={undefined}>
          <DialogHeader>
          ...
          <div className="settings-confirm-actions">
            <Button type="button" variant="ghost" size="large" className="pill-btn pill-btn--lg" onClick={() => setPendingDeleteAction(null)} disabled={isDeleting}>
              {t("common.cancel")}
            </Button>
            <Button type="button" variant="primary" size="large" data-tone="destructive" className="pill-btn pill-btn--danger pill-btn--lg" onClick={() => void handleConfirmDelete()} disabled={isDeleting}>
              {isDeleting
