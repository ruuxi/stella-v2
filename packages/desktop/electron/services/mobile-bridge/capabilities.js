import { IPC_AGENT_CANCEL_CHAT, IPC_AGENT_EVENT, IPC_AGENT_GET_ACTIVE_RUN, IPC_AGENT_GET_SESSION_STARTED_AT, IPC_AGENT_HEALTH_CHECK, IPC_AGENT_RESUME, IPC_AGENT_SEND_INPUT, IPC_AGENT_START_CHAT, IPC_APP_HARD_RESET, IPC_APP_RESET_MESSAGES, IPC_APP_SET_READY, IPC_AUTH_GET_CONVEX_TOKEN, IPC_AUTH_GET_SESSION, IPC_AUTH_SIGN_IN_ANONYMOUS, IPC_AUTH_SIGN_OUT, IPC_BROWSER_BRIDGE_STATUS, IPC_BROWSER_FETCH_JSON, IPC_BROWSER_FETCH_TEXT, IPC_CHAT_CONTEXT_GET, IPC_CHAT_CONTEXT_UPDATED, IPC_CREDENTIAL_CANCEL, IPC_CREDENTIAL_REQUEST, IPC_CREDENTIAL_SUBMIT, IPC_DEVICE_GET_ID, IPC_DISCOVERY_COLLECT_ALL_SIGNALS, IPC_DISCOVERY_COLLECT_BROWSER_DATA, IPC_DISCOVERY_CORE_MEMORY_EXISTS, IPC_DISCOVERY_DETECT_PREFERRED_BROWSER, IPC_DISCOVERY_KNOWLEDGE_EXISTS, IPC_DISCOVERY_LIST_BROWSER_PROFILES, IPC_DISCOVERY_WRITE_CORE_MEMORY, IPC_DISCOVERY_WRITE_KNOWLEDGE, IPC_DISPLAY_LIST_CANVAS_HTML, IPC_DISPLAY_READ_FILE, IPC_DISPLAY_TRASH_FORCE_DELETE, IPC_DISPLAY_TRASH_LIST, IPC_DISPLAY_UPDATE, IPC_HOST_CONFIGURE_RUNTIME, IPC_LOCAL_CHAT_CREATE_NEW_DEFAULT_ID, IPC_LOCAL_CHAT_GET_EVENT_COUNT, IPC_LOCAL_CHAT_GET_OR_CREATE_ID, IPC_LOCAL_CHAT_LIST_ACTIVITY, IPC_LOCAL_CHAT_LIST_EVENTS, IPC_LOCAL_CHAT_LIST_FILES, IPC_LOCAL_CHAT_LIST_MESSAGES, IPC_LOCAL_CHAT_LIST_MESSAGES_BEFORE, IPC_LOCAL_CHAT_LIST_SYNC_MESSAGES, IPC_LOCAL_CHAT_PERSIST_WELCOME, IPC_LOCAL_CHAT_SYNC_MESSAGES, IPC_LOCAL_CHAT_UPDATED, IPC_LOCAL_CHAT_THREAD_ACTIVITY_UPDATED, IPC_LOCAL_CHAT_TASK_DECORATION_UPDATED, IPC_LOCAL_CHAT_LIST_THREAD_ACTIVITY, IPC_LLM_CREDENTIALS_DELETE, IPC_LLM_CREDENTIALS_DELETE_OAUTH, IPC_LLM_CREDENTIALS_LIST, IPC_LLM_CREDENTIALS_LIST_OAUTH, IPC_LLM_CREDENTIALS_LIST_OAUTH_PROVIDERS, IPC_LLM_CREDENTIALS_LOGIN_OAUTH, IPC_LLM_CREDENTIALS_SAVE, IPC_MEDIA_GET_DIR, IPC_MEDIA_SAVE_OUTPUT, IPC_OFFICE_PREVIEW_LIST, IPC_OFFICE_PREVIEW_START, IPC_ONBOARDING_SYNTHESIZE, IPC_PERMISSIONS_GET_STATUS, IPC_PERMISSIONS_OPEN_SETTINGS, IPC_PREFERENCES_GET_MODELS, IPC_PREFERENCES_LIST_CLAUDE_CODE_MODELS, IPC_PREFERENCES_LIST_CODEX_MODELS, IPC_PREFERENCES_SET_MODELS, IPC_SCHEDULE_GET_EVENT_COUNT, IPC_SCHEDULE_LIST_CONVERSATION_EVENTS, IPC_SCHEDULE_LIST_CRON_JOBS, IPC_SCHEDULE_LIST_HEARTBEATS, IPC_SCHEDULE_REMOVE_CRON_JOB, IPC_SCHEDULE_UPDATE_CRON_JOB, IPC_SCHEDULE_UPDATED, IPC_THEME_LIST_INSTALLED, IPC_UI_GET_STATE, IPC_UI_SET_STATE, IPC_UI_STATE, IPC_UI_STATE_KV_APPLY, IPC_UI_STATE_KV_CHANGED, IPC_UI_STATE_KV_CLEAR, IPC_VOICE_GET_RUNTIME_STATE, IPC_VOICE_EXECUTE_MOBILE_TOOL, IPC_VOICE_ORCHESTRATOR_CHAT, IPC_VOICE_ORCHESTRATOR_CONFIG, IPC_VOICE_PERSIST_TRANSCRIPT, IPC_VOICE_RUNTIME_STATE, IPC_VOICE_WEB_SEARCH, } from "@stella/contracts/desktop/ipc-channels";
