...
`;
const injectCanvasSelectionBridge = (html) => {
...
const CanvasIllustrationSpot = ({ label }) => (<div className="canvas-tab__illustration-spot">
    <div className="canvas-tab__illustration-art">
      <CanvasIllustration />
    </div>
    {label ? (<div className="canvas-tab__illustration-label">{label}</div>) : null}
  </div>);
const CanvasHeroFrameContent = ({ item }) => {
...
export const CanvasTabContent = ({ item }) => {
