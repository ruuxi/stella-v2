// Canonical vendored model-catalog snapshot with Stella-maintained overlays.
// Despite the historical filename, no in-repository generator owns this file;
// catalog updates are reviewed and committed directly.

import type { CatalogModel as Model } from "./model-catalog.js";
...
export const MODELS = {
	...
	// HAND-CURATED: Meta Model API is not in the generated models.dev snapshot.
	// Source: https://dev.meta.ai/docs/models and /docs/pricing-rate-limits.
	"meta": {
		"muse-spark-1.1": {
			id: "muse-spark-1.1",
			name: "Muse Spark 1.1",
			...
			compat: {"sendSessionIdHeader":false,"supportsLongCacheRetention":true,"supportsToolSearch":true},
	...
	// PI-MONO SNAPSHOT: the direct ChatGPT OAuth provider uses pi-mono's explicit
