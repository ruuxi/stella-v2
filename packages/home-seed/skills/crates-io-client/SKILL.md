...
```bash
bun ~/.stella/skills/crates-io-client/scripts/program.js search <query> [flags]
bun ~/.stella/skills/crates-io-client/scripts/program.js crate <name>
bun ~/.stella/skills/crates-io-client/scripts/program.js versions <name> [--limit N]
```
