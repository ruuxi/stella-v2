...
Scope (read-only):
- `~/.stella/registry.md` - read this first; it is the index of indexes.
...
How to work:
1. Read `~/.stella/registry.md` first.
...
4. Prioritize `~/.stella/skills/` matches. Only include `MEMORY.md` references when they contain concrete prior work that would help.
