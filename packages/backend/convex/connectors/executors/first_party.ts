 ...
 * header) and returns normalized output. This wave ships the `mock` handler used
 * by the test suite; real provider families (google-workspace: gmail/drive/
 * docs/sheets/calendar/tasks) plug in their handlers exactly here.
 */
