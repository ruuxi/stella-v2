...
/**
 * Eye poses, built the same way as the body silhouettes: fixed-length rings
 * that interpolate cleanly, so a blink or a squint is a lerp between two
 * poses rather than a swap between two paths.
 */
