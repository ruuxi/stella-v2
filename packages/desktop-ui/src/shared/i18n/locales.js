 ...
 * fallback contexts.
 */
export const LOCALE_ENGLISH_NAMES = {
    en: "English",
    es: "Spanish",
    fr: "French",
    de: "German",
...
export const isSupportedLocale = (value) => typeof value === "string" && SUPPORTED_SET.has(value);
/**
 ...
 */
export const matchSupportedLocale = (candidate) => {
    if (!candidate)
        return null;
 ...
 * wins.
 */
export const resolveBestLocale = (candidates) => {
...
export const localeDir = (locale) => isRtlLocale(locale) ? "rtl" : "ltr";
