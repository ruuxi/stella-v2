/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=AppsHostBindings` (hash: be9afda3b7dfd6572fd0b471ca7dee83)
// Runtime types generated with workerd@1.20260828.1 2026-07-22 nodejs_compat
interface __BaseEnv_AppsHostBindings {
	APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
	CLOUD_APPS: Fetcher /* stella-v2-cloud-builder-basic-nightingale-118 */ | Fetcher /* stella-v2-cloud-builder-prod */ | Fetcher /* stella-v2-cloud-builder-dev */;
}
declare namespace Cloudflare {
	...
	interface Bn118Env {
		APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
		CLOUD_APPS: Fetcher /* stella-v2-cloud-builder-basic-nightingale-118 */;
	}
	interface ProductionEnv {
		APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
		CLOUD_APPS: Fetcher /* stella-v2-cloud-builder-prod */;
	}
	interface Env extends __BaseEnv_AppsHostBindings {}
}
interface AppsHostBindings extends __BaseEnv_AppsHostBindings {}
