/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=AppsHostUntrustedBindings` (hash: f07d45d9973243a1901e5767d43533d8)
// Runtime types generated with workerd@1.20260828.1 2026-07-22 nodejs_compat
interface __BaseEnv_AppsHostUntrustedBindings {
	...
	CONVEX_SITE_URL: "https://basic-nightingale-118.convex.site" | "https://intent-jackal-330.convex.site" | "https://outgoing-bulldog-865.convex.site";
	CONVEX_CLOUD_URL: "https://basic-nightingale-118.convex.cloud" | "https://intent-jackal-330.convex.cloud" | "https://outgoing-bulldog-865.convex.cloud";
	APPS_HOST_ORIGIN: "https://stella-v2-apps-host-basic-nightingale-118.lolruuxi.workers.dev" | "https://stella-v2-apps-host-prod.lolruuxi.workers.dev" | "https://stella-v2-apps-host-dev.lolruuxi.workers.dev";
	TRUSTED_APPS_HOST_ORIGIN: "https://stella-v2-apps-auth-basic-nightingale-118.lolruuxi.workers.dev" | "https://stella-v2-apps-auth-prod.lolruuxi.workers.dev" | "https://stella-v2-apps-auth-dev.lolruuxi.workers.dev";
	CLOUD_BUILDER_ORIGIN: "https://stella-v2-cloud-builder-basic-nightingale-118.lolruuxi.workers.dev" | "https://stella-v2-cloud-builder-prod.lolruuxi.workers.dev" | "https://stella-v2-cloud-builder-dev.lolruuxi.workers.dev";
	APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
	APP_AUTH: Service /* entrypoint AppsAuthService from stella-v2-apps-auth-basic-nightingale-118 */ | Service /* entrypoint AppsAuthService from stella-v2-apps-auth-prod */ | Service /* entrypoint AppsAuthService from stella-v2-apps-auth-dev */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AppFetchGate";
	}
	interface Bn118Env {
		APP_ROUTES: KVNamespace;
		APP_BUILDS: R2Bucket;
		...
		APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
		APP_AUTH: Service /* entrypoint AppsAuthService from stella-v2-apps-auth-basic-nightingale-118 */;
	}
	interface ProductionEnv {
		...
		APPS_HOST_ORIGIN: "https://stella-v2-apps-host-prod.lolruuxi.workers.dev";
		TRUSTED_APPS_HOST_ORIGIN: "https://stella-v2-apps-auth-prod.lolruuxi.workers.dev";
		CLOUD_BUILDER_ORIGIN: "https://stella-v2-cloud-builder-prod.lolruuxi.workers.dev";
		APP_FETCH_GATE: DurableObjectNamespace<import("./src/index").AppFetchGate>;
		APP_AUTH: Service /* entrypoint AppsAuthService from stella-v2-apps-auth-prod */;
	}
	interface Env extends __BaseEnv_AppsHostUntrustedBindings {}
}
interface AppsHostUntrustedBindings extends __BaseEnv_AppsHostUntrustedBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STELLA_DEPLOYMENT_IDENTITY" | "HOST_ROLE" | "SHARES_DISABLED" | "CONVEX_SITE_URL" | "CONVEX_CLOUD_URL" | "APPS_HOST_ORIGIN" | "TRUSTED_APPS_HOST_ORIGIN" | "CLOUD_BUILDER_ORIGIN">> {}
}
