...
```bash
bun ~/.stella/skills/hackernews-client/scripts/program.js search <query> [flags]
bun ~/.stella/skills/hackernews-client/scripts/program.js front [--limit N]
bun ~/.stella/skills/hackernews-client/scripts/program.js item <id>
```
