...
export function VoiceSessionCard({ durationMs }) {
    return (<span className="voice-session-pill">
      <AudioLines className="voice-session-pill__icon" size={13} strokeWidth={1.75} aria-hidden="true"/>
