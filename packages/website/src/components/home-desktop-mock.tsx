...
const WORKSPACE_ACTIVITY = [
  ...
  {
    label: "Added dinner reservation reminders",
    icon: CheckCircle2,
    state: "done",
  },
  ...
  return (
    <div className={styles.chatContent}>
      <div
        ...
        aria-label="Stella chat mock conversation"
      >
        <div className={styles.userMessage}>
          Can you help plan Saturday around the school form and dinner?
        </div>
        <div className={styles.assistantRow}>
          <p className={styles.assistantMessage}>
            Yes. I found the form deadline, a dinner slot near the theater, and
            a grocery route that fits.
          </p>
        </div>
        <div className={styles.userMessage}>
          Text Mom the plan and make a short checklist.
        </div>
        <div className={styles.assistantRow}>
          <p className={styles.assistantMessage}>
            Drafted the message and made a checklist with tickets, the form,
            groceries, and the reservation.
          </p>
        </div>
        <div className={styles.userMessage}>
          Turn the receipt into a spreadsheet too.
        </div>
        <div className={styles.assistantRow}>
          <p className={styles.assistantMessage}>
      ...
      <Composer showContext className={styles.chatComposerWrap} />
    </div>
  );
}
            ...
            {WORKSPACE_ACTIVITY.map((item) => {
              ...
              return (
                <li key={item.label} className={styles.workspaceTaskRow}>
                  <span
                    className={styles.workspaceTaskIconWrap}
                    aria-hidden="true"
                  >
                    <Icon
                      size={15}
                  ...
                  <span className={styles.workspaceTaskLabel}>
                    {item.label}
                  </span>
                </li>
              );
              ...
              return (
                <li key={item.label} className={styles.workspaceRow}>
                  <button type="button" className={styles.workspaceFileButton}>
                    ...
                    <span className={styles.workspaceFileName}>
                      {item.label}
                    </span>
                  </button>
                </li>
...
function MiniChatWindow({
  ...
  return (
    <div
      className={
        className ? `${styles.miniWindow} ${className}` : styles.miniWindow
      }
      style={vars}
      data-mode={mode}
      data-theme={themeId}
...
export function HomeMiniChatMock({
  ...
  const resolvedMode = selectedTheme.forcedMode ?? "light";
