...
export type PublicApiType = {
  ...
  "execution_placement": {
    "submitMyBrowserExecution": FunctionReference<'mutation', 'public', { threadId?: string | undefined; workspace?: string | undefined; parentTurnId?: string | undefined; conversationId: string; kind: 'agent' | 'chat'; idempotencyKey: string; payloadJson: string; subject: 'cloud' | 'portable' | 'computer'; payloadHash: string; requiredCapabilities: ('agent' | 'chat' | 'computer-use' | 'local-files' | 'local-apps')[]; expectedOwnerGeneration: string; }, any, string | undefined>;
