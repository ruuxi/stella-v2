/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=AppsHostUntrustedBindings` (hash: 5705b9ef7474dc68a32aa850bfa3414e)
...
interface __BaseEnv_AppsHostUntrustedBindings {
	...
	APP_AUTH: Service /* entrypoint AppsAuthService from stella-v2-apps-auth-basic-nightingale-118 */ | Service /* entrypoint AppsAuthService from stella-v2-apps-auth-dev */;
}
