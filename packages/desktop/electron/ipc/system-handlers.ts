...
import { deleteLocalLlmCredential, getLocalLlmCredential, listLocalLlmCredentials, saveLocalLlmCredential, } from "../../../runtime/kernel/storage/llm-credentials.js";
import { cleanupRetiredLocalLlmOAuthCredentials, deleteLocalLlmOAuthCredential, getLocalLlmOAuthApiKey, listLocalLlmOAuthCredentials, saveLocalLlmOAuthCredential, } from "../../../runtime/kernel/storage/llm-oauth-credentials.js";
...
export const registerSystemHandlers = (options) => {
    ...
    ipcMain.handle("llmCredentials:deleteOAuth", (event, payload) => {
        ...
        return deleteLocalLlmOAuthCredential(stellaAppDir, asTrimmedString(payload?.provider));
    });
    ...
    ipcMain.handle("llmCredentials:delete", (event, payload) => {
        ...
        return deleteLocalLlmCredential(stellaAppDir, asTrimmedString(payload?.provider));
    });
